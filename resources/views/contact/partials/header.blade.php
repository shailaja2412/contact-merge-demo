...
<div class="p-4">
    ...
    <div x-show="filterOpen" style="display: none;" 
        ...
        <div class="flex flex-wrap gap-4 items-end">
            ...
            <!-- Phone/Mobile Filter -->
            <div class="flex-1 min-w-[200px]">
                <label for="filter-phone" class="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">Phone/Mobile</label>
                <input type="text" id="filter-phone" name="phone" placeholder="Search by phone..."
                    class="w-full px-4 py-2 rounded-lg
                           bg-white dark:bg-gray-700
                           border border-gray-300 dark:border-gray-600
                           text-gray-900 dark:text-gray-100
