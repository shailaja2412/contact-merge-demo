    ...
    <div x-data="{
        ...
        <div class="p-4 flex flex-wrap gap-4 justify-between items-center">
            ...
            <button @click="openCreate()"
                class="px-6 py-2.5  text-lg text-white
                       rounded-full
        ...
        <table class="w-full text-sm text-left text-gray-600 dark:text-gray-300">
            <thead class="bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-200">
                <tr>
                    ...
                    <th class="px-6 py-3 text-lg">Field</th>
                    <th class="px-6 py-3 text-lg">Type</th>
                    <th class="px-6 py-3 text-center text-lg">Action</th>
                </tr>
            </thead>
        ...
        <div x-show="open" x-transition.opacity x-cloak style="display: none;"
            ...
            <div @click.outside="open = false" x-transition.scale
                ...
                <!-- Form -->
                <form id="custom-field-form" class="mt-6 space-y-4" method="POST"
                    ...
                    <div>
                        ...
                        <input type="text" name="field_name" x-model="field_name" required
           ...
           text-gray-900 dark:text-white">
                    ...
                    <div>
                        ...
                        <select name="field_type" x-model="field_type"
                            class="w-full px-4 py-2.5 rounded-lg
           bg-gray-100 dark:bg-gray-800
           border border-gray-300 dark:border-gray-600
           text-gray-900 dark:text-white">
        ...
        <div x-show="deleteOpen" x-transition.opacity x-cloak style="display: none;"
            ...
            <div @click.outside="deleteOpen = false" x-transition.scale
                ...
                <form x-bind:action="`{{ url('admin/custom_fields') }}/${deleteId}`" method="POST" class="mt-6">
                    ...
                    <p class="text-sm text-gray-700 dark:text-gray-300">Are you sure you want to delete this custom
                        field? This action cannot be undone.</p>
                    <div class="flex justify-end gap-3 pt-4 border-t dark:border-gray-700">
            ...
            async function doSearch(query) {
                ...
                try {
                    ...
                    if (text.indexOf('<html') !== -1 || text.indexOf('<!doctype') !== -1) {
                        ...
                        list.innerHTML =
                            '<tr><td colspan="4" class="px-6 py-4 text-center text-gray-500">Session may have expired. Please reload the page.</td></tr>';
                        return;
                    }

                    console.warn('[search] unexpected response');
                    list.innerHTML =
                        '<tr><td colspan="4" class="px-6 py-4 text-center text-gray-500">No results or unexpected response. Check console/network.</td></tr>';
                    ...
                    list.innerHTML =
                        '<tr><td colspan="4" class="px-6 py-4 text-center text-gray-500">Search failed. Try again later.</td></tr>';
                } finally {
                    showSpinner(false);
                }
            }
